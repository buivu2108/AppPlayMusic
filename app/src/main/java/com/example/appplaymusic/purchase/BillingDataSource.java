...
package com.example.appplaymusic.purchase;
...
public class BillingDataSource implements LifecycleObserver, PurchasesUpdatedListener,
    ...
    final private Map<String, SkuDetails> skuDetailsLiveDataMap = new HashMap<>();
    ...
    public final String getSkuTitle(String sku) {
        SkuDetails skuDetails = skuDetailsLiveDataMap.get(sku);
        if (skuDetails != null){
    ...
    public final String getSkuDescription(String sku) {
        return skuDetailsLiveDataMap.get(sku).getDescription();
    }
            ...
            case BillingClient.BillingResponseCode.OK:
                ...
                if (skuDetailsList == null || skuDetailsList.isEmpty()) {
                    ...
                    for (SkuDetails skuDetails : skuDetailsList) {
                        ...
                        skuDetailsLiveDataMap.put(sku, skuDetails);
                    }
                }
                break;
